  ...
  render(): JSX.Element {
    return (
      <Menu>
        ...
        <MenuItem icon='filter-remove' text='Reset Coveragee Filter' onClick={() => this.props.resetCoverage()}/>
        <MenuItem icon='filter-remove' text='Reset Taxonomies Filter' onClick={() => this.props.resetTaxonomies()}/>
